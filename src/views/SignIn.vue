<template>
  <form @submit.prevent="login" class="flex flex-col border-solid border-black border px-8 py-8 items-center">
...
export default {
  ...
  methods: {
    async login() {
      if (!this.username || !this.password) return alert("fill all");
